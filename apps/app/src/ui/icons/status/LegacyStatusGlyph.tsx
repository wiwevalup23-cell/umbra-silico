// Pre-Compass status glyphs. No longer offered in the status/symbol pickers,
// but kept so statuses already saved on a note or in the local custom-status
// list (encoded as `custom:<icon>:<label>`) keep rendering an icon instead of
// falling back to raw text.
type LegacyStatusGlyphProps = {
  className?: string
  symbol: string
}

export function LegacyStatusGlyph({ className, symbol }: LegacyStatusGlyphProps) {
  return (
    <svg
      aria-hidden="true"
      className={className}
