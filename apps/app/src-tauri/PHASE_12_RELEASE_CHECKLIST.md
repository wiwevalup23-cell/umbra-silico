...
Phase 12 packages Silicon Nostalgia as an Ubuntu desktop app through Tauri.
...
```text
apps/app/src-tauri/target/release/bundle/deb/Silicon Nostalgia_0.0.0_amd64.deb
apps/app/src-tauri/target/release/bundle/appimage/Silicon Nostalgia_0.0.0_amd64.AppImage
```
